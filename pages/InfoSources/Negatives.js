...
export default function Negatives({ content, scroll }) {
  return (
    <>
  ...
  return {
    props: {
      content: {
        ...
        p9:
          "There is also no degree or really, any certification worth anything. Most of what you get is experience, which you could get from self teaching but not everyone has the willpower and ability to self teach in isolation.",
        p10:
          "An important note is that, many students don't stay at 42 for long. At 42 SV, people tend to fall in two camps: Those who stay for 3-12 months then leave for full time jobs, and those that stay for longer then eventually leave without finishing the program.  This leads to the exceptional people going through 42 like a revolving door, not staying long enough to really help people as well as losing all those experienced people in general.",
        p11Header: "Funding?",
        p11:
          "For funding, 42 SV is seeded and funded for the first 10 years since it's founding. It was established in 2016 and as of writing this, it's 2020. So it's almost halfway through its alloted money. I've heard from past students that the security guards that work there since the beginning, say that it's funded. The person who funded it, Xavier Niel hasn't really said much about 42 SV that I can find after opening. It's definitely not as successful as 42 Paris or even the other 42/21 places around the world.  I should add that Mr. Niel did say that he wanted continued funding to be done by previous students donating back to the school. I haven't actually found many cases of this happening...so time will tell.",
        p13:
          "There are also rumors that previous Bocal when 42 first started, had embezzled money and since then, funding is allgedly more strict from 42 Paris. Though there has been a recent hiring of a new Executive Director with a background in non-profit organizations and community out reach. He's been there for a year and some things have changed, like updating the curriculum finally after 2 years of being behind the other campuses, but time will tell if he can make 42 Silicon Valley as successful as 42 Paris.",
        p14Header: "TL;DR",
        p14:
          "As an end note, 42 Silicon Valley has it's faults and it's not perfect. If you feel uneasy about 42 but still want to learn how to program, consider starting with Web Development with The Odin Project or go to college.",
      },
      scroll: [
        { stop: "1", title: "Negatives" },
        { stop: "2", title: "42 Paris reddit thread" },
        { stop: "3", title: "Problems with the system" },
        { stop: "4", title: "Not a real school" },
        { stop: "5", title: "Funding?" },
        { stop: "6", title: "TL;DR" },
      ]
    }
  };
