  ...
  return {
    props: {
      content: {
        ...
        p4: "Here's a reddit thread discussing 42 Paris, I found it to be somewhat informative for the applicable things for 42 SV. A wayback link is also attached to read previously deleted/edited comments. Do keep in mind that this person was not accepted and did not pass the Piscine.",
        ...
        p9: "There is also no degree or really, any certification worth anything. Most of what you get is experience, which you could get from self teaching but not everyone has the willpower and ability to self teach in isolation.",
        ...
        p13: "There are also rumors that previous Bocal when 42 first started, had embezzled money and since then, funding is allgedly more strict from 42 Paris. Though there has been a recent hiring of a new Executive Director with a background in non-profit organizations and community out reach. He's been there for a year and some things have changed, like updating the curriculum finally after 2 years of being behind the other campuses, but time will tell if he can make 42 Silicon Valley as successful as 42 Paris.",
        p14Header: "TL;DR",
        p14: "As an end note, 42 Silicon Valley has it's faults and it's not perfect. If you feel uneasy about 42 but still want to learn how to program, consider starting with Web Development with The Odin Project or go to college.",
      },
    },
  };
}
